...
camera_intrinsics.set_intrinsics(width, height, 500.0, 500.0, width / 2, height / 2)

#creating o3d point cloud
pcd_raw = o3d.geometry.PointCloud.create_from_rgbd_image(rgbd_image, camera_intrinsics)
o3d.visualization.draw_geometries([pcd_raw])

#post processing of point cloud
